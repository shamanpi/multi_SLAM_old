...
if("TRUE" STREQUAL "TRUE")
  set(navigation_SOURCE_PREFIX /home/sam/multi_SLAM/src/navigation)
  set(navigation_DEVEL_PREFIX /home/sam/multi_SLAM/devel)
  ...
  set(navigation_INSTALL_PREFIX /home/sam/multi_SLAM/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'navigation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sam/multi_SLAM/src/navigation/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/sam/multi_SLAM/devel/lib;/home/sam/robotics/devel/lib;/home/sam/turtle/devel/lib;/opt/ros/melodic/lib)
